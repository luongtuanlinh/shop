        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="box box-primary" style="padding: 20px 30px;">
                <div class="box-action">
                    <button class="btn btn-primary btn-sm add-cate" data-toggle="modal" data-target="#modal-add-category" data-id="0">Thêm thể loại mới</button>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body box-add-cate">
                <form action="{{ route('product.category.addcate') }}" method="POST" name="form-add-cate">
...
<div id="modal-edit-category" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body box-add-cate">
                    <form action="{{ route('product.category.editcate') }}" method="POST" name="form-add-cate">
                        <input type="hidden" name="_token" value="{{csrf_token()}}" />
